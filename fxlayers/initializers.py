...
# %% auto 0
__all__ = ['bounded_uniform', 'displaced_normal', 'freq_scales_init', 'k_array', 'linspace', 'equal_to', 'mean_conv']
...
# %% ../Notebooks/01_initializers.ipynb 19
def mean_conv(dtype=dtypes.float_ # Desired DType of the resulting array.
              ):
